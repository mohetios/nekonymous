...
باهاش می‌تونی لینک پیام ناشناس بسازی، پیام بگیری، پاسخ ناشناس بدی، و اگه خواستی از ارزیابی سبک گفت‌وگو و پیشنهاد گفت‌وگو استفاده کنی.

نِکونیموس پیام‌رسان رمزنگاری سرتاسری نیست و ناشناسی کامل رو تضمین نمی‌کنه. تلگرام و سرور بات هنگام پردازش، متن پیام رو می‌بینن.
EOF
