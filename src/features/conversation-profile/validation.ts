...
export const getMissingQuestionIds = (answers: ProfileAnswers): string[] =>
  PROFILE_QUESTIONS.filter((question) => {
    const value = answers[question.id];
    return value === undefined || !validateAnswerForQuestion(question, value);
